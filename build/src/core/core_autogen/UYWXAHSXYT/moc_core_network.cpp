/****************************************************************************
** Meta object code from reading C++ file 'core_network.hpp'
**
...
#include <memory>
#include "../../../../../src/core/core_network/core_network.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'core_network.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_NetworkInfo_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_NetworkInfo_t qt_meta_stringdata_NetworkInfo = {
    {
QT_MOC_LITERAL(0, 11) // "NetworkInfo"
...
const QMetaObject NetworkInfo::staticMetaObject = { {
    ...
    qt_meta_stringdata_NetworkInfo.offsetsAndSize,
    qt_meta_data_NetworkInfo,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_NetworkInfo_t
